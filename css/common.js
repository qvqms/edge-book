...
$(function(){
    ...
    rightNav += "<li><a href='index.html' target='_blank'>苏维埃XP</a></li>";
    rightNav += "<li><a href='html/time.html' target='_blank'>记录线</a></li>";
    rightNav += "<li><a href='Download.html' target='_blank'>下载苏维埃XP</a></li>";
    rightNav += "<li><a href='http://www.qijishow.com/down/index.html' target='_blank'>宸ュ叿绠�</a></li>";
	rightNav += "<li><a href='http://www.qijishow.com/down/resource.html' target='_blank'>璧勬簮搴�</a></li>";
    rightNav += "<hr>";
    rightNav += "<li class='qrBtn'><a href='http://www.qijishow.com/Brand/Brand5/index.htm' target='_blank'>寰俊鍏紬鍙�</a></li>";
    rightNav += "<li class='qrBox'><img src='http://www.qijishow.com/img/ewm01.jpg' alt='寰俊浜岀淮鐮�'/></li>";
    rightNav += "</ul>";
